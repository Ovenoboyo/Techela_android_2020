package com.sitfest.techela.ui;
...
public class RoundedImageViewNoMargin extends AppCompatImageView {
    ...
    public RoundedImageViewNoMargin(Context context) {
        super(context);
    }

    public RoundedImageViewNoMargin(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundedImageViewNoMargin(Context context, AttributeSet attrs, int defStyle) {
